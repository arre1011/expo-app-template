...
import { MySubscriptionSheet } from '@/features/core/subscription/components/MySubscriptionSheet';
import { useSubscriptionStatus } from '@/features/core/subscription/state/useSubscriptionStore';
import { resetDatabase } from '@/infrastructure/sqlite/connection';
import {
  sendTestReminder,
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {isFeatureEnabled('subscriptionSection') && (
          <>
