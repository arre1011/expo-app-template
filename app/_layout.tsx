...
import { featureFlags, devOfferOverride, devOfferConfig } from '../src/config/featureFlags';
...
function RootLayout() {
  ...
  useEffect(() => {
    // Dev override: skip DeepLinkNow and force a specific variant
  ...
  useEffect(() => {
    ...
    const handleUrl = (event: { url: string }) => {
      ...
      if (offer) {
        ...
        posthog.capture(AnalyticsEvents.DEEP_LINK_OFFER_APPLIED, {
